...
import './screen.css';
import { BookFilled,DingdingOutlined  } from '@ant-design/icons';
...
class App extends Component {
  ...
  render() {
    return (
      <Router>
        <Layout>
          <Header className="header" style={{backgroundColor:'darkgreen',color:"#e89a3c" ,height: "120px" }}>
            <div className="headertext">
              <label><DingdingOutlined   style={{color:"#e89a3c" ,fontSize:"40px", marginRight:"10px"}} />Numerical Method</label>
            </div>
          </Header>
          <Layout>
            ...
            <Layout style={{backgroundColor:'#E4A900', padding: '0 25px 25px' }}>
          ...
          <Footer style={{ backgroundColor: "green", minHeight: 120 }}>
